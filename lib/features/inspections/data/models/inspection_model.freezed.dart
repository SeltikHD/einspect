...
mixin _$InspectionModel {
 ...
 String get clientId; String get workOrderId; String? get serverId; String? get observation; String? get condition; double? get latitude; double? get longitude; String? get photoPath; String get status; String? get failureReason; DateTime? get capturedAt; DateTime? get syncedAt; DateTime get createdAt; DateTime get updatedAt;
...
@useResult
$Res call({
 String clientId, String workOrderId, String? serverId, String? observation, String? condition, double? latitude, double? longitude, String? photoPath, String status, String? failureReason, DateTime? capturedAt, DateTime? syncedAt, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of InspectionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? clientId = null,Object? workOrderId = null,Object? serverId = freezed,Object? observation = freezed,Object? condition = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? photoPath = freezed,Object? status = null,Object? failureReason = freezed,Object? capturedAt = freezed,Object? syncedAt = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String clientId,  String workOrderId,  String? serverId,  String? observation,  String? condition,  double? latitude,  double? longitude,  String? photoPath,  String status,  String? failureReason,  DateTime? capturedAt,  DateTime? syncedAt,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InspectionModel() when $default != null:
return $default(_that.clientId,_that.workOrderId,_that.serverId,_that.observation,_that.condition,_that.latitude,_that.longitude,_that.photoPath,_that.status,_that.failureReason,_that.capturedAt,_that.syncedAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _InspectionModel extends InspectionModel {
  const _InspectionModel({required this.clientId, required this.workOrderId, this.serverId, this.observation, this.condition, this.latitude, this.longitude, this.photoPath, this.status = 'draft', this.failureReason, this.capturedAt, this.syncedAt, required this.createdAt, required this.updatedAt}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,clientId,workOrderId,serverId,observation,condition,latitude,longitude,photoPath,status,failureReason,capturedAt,syncedAt,createdAt,updatedAt);
}

@override
String toString() {
    return 'InspectionModel(clientId: $clientId, workOrderId: $workOrderId, serverId: $serverId, observation: $observation, condition: $condition, latitude: $latitude, longitude: $longitude, photoPath: $photoPath, status: $status, failureReason: $failureReason, capturedAt: $capturedAt, syncedAt: $syncedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of InspectionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? clientId = null,Object? workOrderId = null,Object? serverId = freezed,Object? observation = freezed,Object? condition = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? photoPath = freezed,Object? status = null,Object? failureReason = freezed,Object? capturedAt = freezed,Object? syncedAt = freezed,Object? createdAt = null,Object? updatedAt = null,}) {

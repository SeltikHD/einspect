...
mixin _$LoginResponseModel {
 ...
 String get accessToken; String get tokenType; int get expiresIn; UserModel get user;
...
bool operator ==(Object other) {
  final _this = this as LoginResponseModel;
...
int get hashCode {
  final _this = this as LoginResponseModel;
  return Object.hash(runtimeType,_this.accessToken,_this.tokenType,_this.expiresIn,_this.user);
}

@override
String toString() {
  final _this = this as LoginResponseModel;
  return 'LoginResponseModel(accessToken: ${_this.accessToken}, tokenType: ${_this.tokenType}, expiresIn: ${_this.expiresIn}, user: ${_this.user})';
}
...
@useResult
$Res call({
 String accessToken, String tokenType, int expiresIn, UserModel user
});
...
/// Create a copy of LoginResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? tokenType = null,Object? expiresIn = null,Object? user = null,}) {
  return _then(LoginResponseModel(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String tokenType,  int expiresIn,  UserModel user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String tokenType,  int expiresIn,  UserModel user)  $default,) {final _that = this;
switch (_that) {
case _LoginResponseModel():
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String tokenType,  int expiresIn,  UserModel user)?  $default,) {final _that = this;
switch (_that) {
case _LoginResponseModel() when $default != null:
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.user);case _:
  return null;
...
class _LoginResponseModel extends LoginResponseModel {
  const _LoginResponseModel({required this.accessToken, required this.tokenType, required this.expiresIn, required this.user}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,accessToken,tokenType,expiresIn,user);
}

@override
String toString() {
    return 'LoginResponseModel(accessToken: $accessToken, tokenType: $tokenType, expiresIn: $expiresIn, user: $user)';
}
...
/// Create a copy of LoginResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? tokenType = null,Object? expiresIn = null,Object? user = null,}) {
